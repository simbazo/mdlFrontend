...
import {AddressComponent} from './../../interfaces/shared/Address';
import {Countries} from './../../interfaces/shared/Countries';
...
export class GooglePlaceService {
  ...
  countryIsoCode() {
    return Countries.COUNTRY_ISO_CODE;
  }

  // Types options
  TypesOptions() {
    return Countries.TYPE_OPTIONS;
  }
